                         ...
                         <p>Full Stack Software Developer</p>
                            <div className="decagon-container">
                                <div className="decagon">
                                    ...
                                    <li>Collaborating with cross-functional teams including designers, product managers 
                                ...
                                <div>
                                    <span className="decagon-img"><img src="https://techcrunch.com/wp-content/uploads/2018/11/Decagon-Logo-main.png" alt="decagon's logo" /></span>
                                </div>
                            </div>
                    ...
                    <h3>BEDC Electricity Plc</h3>
                        <p>Management Officer(2017-2022)</p>
                            <div className="bedc-container">
                                ...
                                <div>
                                    <span className="bedc-img"><img src="https://beninelectric.com/wp-content/uploads/2022/10/BEDC-Logo-new-dark-1.png" alt="bedc logo" /></span>
                                </div>
                            </div>
            </ul>
            </div>
